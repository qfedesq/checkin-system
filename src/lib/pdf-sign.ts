...
const IMG_MAX_W = 90;
const IMG_MAX_H = 50;
// Modo "sólo firma": la imagen se estampa sola (sin recuadro), centrada en el punto
// marcado por el admin, con este ancho máximo (nunca se agranda más allá del original).
const SOLO_IMG_MAX_W = 120;
...
export async function signPdf(
  ...
  opts?: { anchor?: SignAnchor; page?: number | null; x?: number | null; y?: number | null },
) {
